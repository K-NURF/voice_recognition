...
model = WhisperForConditionalGeneration.from_pretrained("/home/k_nurf/voice_recognition/whisper-small-sw").to(device)
...
training_args = Seq2SeqTrainingArguments(
    output_dir="/home/k_nurf/voice_recognition/whisper-small-sw",
    ...
    push_to_hub=False,
    resume_from_checkpoint="/home/k_nurf/voice_recognition/whisper-small-sw/checkpoint-6000",
)
